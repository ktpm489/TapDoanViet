        ...
        return (
            ...
            {fromSubDichVu?
               ...
               <View style ={{flex:1,justifyContent: 'center',alignItems:'center',marginLeft:2,marginRight:2}}>
                    <Text style={{textAlign:'center',fontSize:10, alignSelf:'center',color:'#ffffff',fontWeight:'bold',}}>{fromSubDichVu? item.serviceName.toUpperCase():item.name.toUpperCase()}</Text>
                </View>
                </View>
                :<View key={item.index}
                style={{flex: 1,
         ...
         />
              <Text style={{textAlign:'center',fontSize:10,color:'black',fontWeight:'bold',marginLeft:2,marginRight:2}}>{fromSubDichVu? item.serviceName.toUpperCase():item.name.toUpperCase()}</Text>
          </View>}
