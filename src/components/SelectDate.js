...
export default class SelectDate extends Component {
    ...
    constructor(props) {
        ...
        var arrHourse = ['8:00','9:00','10:00','11:00','12:00','13:00','14:00','15:00','16:00','17:00',
                        '18:00','19:00','20:00']
        var listHours =[];
    ...
    onHourSelect =(positionHourSelect)=>{
        ...
        console.log("slect posmoi",positionHourSelect);
            ...
            console.log('arr: ',this.state.listHours);
    }
    ...
    render() {
        ...
        var titleDate = dateSelect.nameDate +" "+ dateSelect.date+"/"+dateSelect.month;
        ...
        return (
            ...
            <View style={{flex:1}}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    >
                        <Image
                            source={this.state.prev?require('../images/arrow-left-blue.png'):require('../images/arrow-left-gray.png')}
                            style={{ width: 25, height: 25, margin: 10, }}

                        />
                    </TouchableOpacity>
                    <Text style={{ flex: 1, alignSelf: 'stretch', textAlign: 'center', textAlignVertical: 'center' }}>{titleDate}</Text>
                    <TouchableOpacity
                       onPress={()=>{
                        if(!this.state.next)
                            return 0;
                    ...
                    >
                        <Image
                            source={this.state.next?require('../images/arrow-right-blue.png'):require('../images/arrow-right-gray.png')}
                            style={{ width: 25, height: 25, margin: 10, }}
