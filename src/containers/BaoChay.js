...
class BaoChay extends Component {
    constructor(props){
        super(props)
        this.state = {
            isCheck:true,
    ...
    BaoCaoSaiPham =  ()=> {
        ...
        if (this.state.MoTa == "") {
            Alert.alert("Thông báo", "Nhập nội dung báo cháy (địa điểm, mức đô, nguyên nhân...)");
        }
        else {
            ...
            <View>
                ...
                <View style = {styles.viewWrap}>
                    <TextInput
                        ...
                        placeholder = 'Nhập nội dung báo cháy (địa điểm, mức đô, nguyên nhân...)'
...
BaoChay = connect(mapStateToProps, mapDispatchToProps)(BaoChay);

export default BaoChay
